...
## ✨ Key Features
Employee breakdown by gender (882 Male, 588 Female), job levels (e.g., Level 1: 543), and distance status (63.95% Very far).sss
...
(Attach PDF screenshots or export images here for visuals.)
...
Refresh data if connected to source (e.g., Excel/CSV with employee data).

Interact via slicers for departments, roles, and metrics.
​
​
...
Metrics	Employee counts, %, service years
Data Scope	1,470 employees, job roles, satisfaction
📈 Insights
92% not due for promotion; focus on 72 high-performers.

High retrenchment risk in Managers (44) and Sales.
